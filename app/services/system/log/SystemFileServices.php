    ...
    public function getFileList()
    {
        ...
        if (empty($file)) {
            ...
            foreach ($arr as $ko => $vo) {
                ...
                if ($update_time) {
                    $data['atime'] = isset($update_time['atime']) && (int)$update_time['atime'] ? date('Y-m-d H:i:s', (int)$update_time['atime']) : '';
                    $data['mtime'] = isset($update_time['mtime']) && (int)$update_time['mtime'] ? date('Y-m-d H:i:s', (int)$update_time['mtime']) : '';
                    $data['ctime'] = isset($update_time['ctime']) && (int)$update_time['ctime'] ? date('Y-m-d H:i:s', (int)$update_time['ctime']) : '';
                }
