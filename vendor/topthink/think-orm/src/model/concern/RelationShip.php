...
trait RelationShip
{
	 ...
	 * @param  bool $softDelete 安全删除
     * @return HasOne
     */
    public function hasOne(string $model, string $foreignKey = '', string $localKey = '', bool $softDelete = true): HasOne
    {
        // 记录当前关联信息
        ...
        return new HasOne($this, $model, $foreignKey, $localKey, $softDelete);
    }
